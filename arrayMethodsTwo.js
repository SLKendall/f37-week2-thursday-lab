...
const citiesThatEndWithI = cities.filter((city) => city.slice(city.length-1)=== "i")
...
/* 
    ...
    If the color is red, print "The fruit with index [THE ELEMENT'S INDEX] is an apple." If the color is orange, print 
    "The fruit with index [THE ELEMENT INDEX] is an orange." If the color is not red or apple, print 
    "The fruit with index [THE ELEMENT'S INDEX] is neither apple or orange."
...
// CODE HERE
const meatFoods = foods.filter((el) => el.tags.includes("meat")).reduce((acc, cur) => acc + cur.price, 0)

// const meatPrice = meatFoods.reduce((acc, cur) => acc + cur.price, 0)
