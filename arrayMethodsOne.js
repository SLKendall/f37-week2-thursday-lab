...
const postTaxArray = prices.map((elem) => (elem * 1.07))

console.log(postTaxArray)
////////// PROBLEM 3 //////////
...
const sumOfPop = numbers => {
  return numbers.reduce((acc,cur) => acc + cur)
}

console.log(sumOfPop(populations))
...
const bobTotal = bobFilter.reduce((acc, cur) => acc + cur.price, 0)
